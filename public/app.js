...
const {
  locale
} = require('moment'); //DE ESTA FORMA REQUERIMOS EL LENGUAJE EN ESPAÑOL DEL FORMATO DE LA HORA


require('moment/locale/es');

moment.locale('es'); //DESPUÉS REQUERIMOS LOS MÓDULOS DE LA HOMEPAGE Y SIGNUP, RESPETANDO EL ORDEN DE LA MISMA.
...
const moment = require('moment'); //CONTINUAMOS CREANDO UN ARCHIVO INDEX EN DONDE COLOCAREMOS LA LÓGICA DE NUESTRO PROYECTO CON REFERENCIA A LAS IMÁGENES SUBIDAS
...
},{"../landing/index":23,"yo-yo":18}],28:[function(require,module,exports){
const page = require('page');
