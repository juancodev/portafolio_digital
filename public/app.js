...
page('/', function (ctx, next) {
  title('Portafolio');
  let main = document.getElementById('main-container'); //EN ESTE CASO PONDREMOS UN OBJETO CON LOS DATOS, ICONOS Y USUARIO QUIEN SUBIÓ LA FOTO
...
const page = require('page'); //DESPUÉS REQUERIMOS LOS MÓDULOS DE LA HOMEPAGE Y SIGNUP, RESPETANDO EL ORDEN DE LA MISMA.
...
const yo = require('yo-yo'); //CONTINUAMOS CREANDO UN ARCHIVO INDEX EN DONDE COLOCAREMOS LA LÓGICA DE NUESTRO PROYECTO CON REFERENCIA A LAS IMÁGENES SUBIDAS
...
module.exports = function pictureCards(pic) {
  ...
  function like() {
    ...
    pic.liked = true; //SE LE INDICA A EL OBJETO CON SU PROPIEDAD pic.likes LA SUMA O LA RESTA

    pic.likes++; //SE CREA LA NUEVA VARIABLE QUE SE VA A ENCARGAR DE GUARDAR LOS NUEVOS CAMBIOS
...
},{"../landing/index":21,"yo-yo":16}],26:[function(require,module,exports){
const page = require('page');
